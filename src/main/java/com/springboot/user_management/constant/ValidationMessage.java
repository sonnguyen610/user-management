...
public class ValidationMessage {
    ...
    public static final String ORDER_TYPE_NOT_BLANK = "Order type cannot be blank!";
    ...
    public static final String PRODUCT_NOT_NULL = "Product must not be null!";
    ...
    public static final String ORDER_TYPE_NOT_VALID = "Order type not valid!";
}
